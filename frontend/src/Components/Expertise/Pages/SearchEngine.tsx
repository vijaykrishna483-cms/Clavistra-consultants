  ...
  const cardData: Card[] = [
    {
      ...
      text: "Strategically plan and organize content to maintain consistency and maximize engagement.",
      imgSrc:
    ...
    {
      title: "Blog Writing & SEO Copywriting",
      text: "Craft compelling, search-optimized content that educates, informs, and ranks.",
      imgSrc:
        "https://images.unsplash.com/vector-1741782393719-b712c654b575?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      title: "Video & Reels Production",
      text: "Create high-quality videos and reels that captivate audiences and enhance brand storytelling.",
      imgSrc:
        "https://images.unsplash.com/vector-1741097263433-fce482e17e2b?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      title: "Email Marketing & Newsletter Content",
      text: "Design engaging email campaigns that nurture leads and drive conversions.",
      imgSrc:
        "https://images.unsplash.com/vector-1739887192005-41b9c4576f0f?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      title: "Podcast Strategy & Production",
      text: "Develop and produce impactful podcasts that position your brand as a thought leader.",
      imgSrc:
    ...
    {
      title: "Thought Leadership & PR Content",
      text: "Establish authority with insightful articles, press releases, and industry-leading content.",
      imgSrc:
    ...
    {
      title: "AI-Optimized Content Development11",
      text: "Leverage AI to create data-driven, high-performing content tailored to your audience.",
      imgSrc:
        "https://images.unsplash.com/vector-1739128047930-37736a69d3b5?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
  ];
          ...
          <div className="flex flex-col md:flex-row items-center ] md:px-[10%]  py-0 gap-10">
            ...
            >
              ...
              <p className="text-gray-600 md:text-xl mt-4 ">
                Every brand has a story to tell, and the right content makes it
                unforgettable. We help you craft compelling narratives that not
                only capture attention but also build trust, engage your
                audience, and drive action. Through strategic planning and
                high-quality content creation, we ensure your message is heard,
                felt, and remembered. Whether it’s words, visuals, or videos, we
                blend creativity with purpose to bring your brand to life. Let’s
                create content that doesn’t just fill space but creates
