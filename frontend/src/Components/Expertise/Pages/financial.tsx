...
const Website = () => {
  ...
  const cardData = [
    { title: 'Financial Planning & Budgeting', text: 'Create strategic financial plans that ensure stability and long-term growth.', imgSrc: '  https://images.unsplash.com/vector-1741097263399-022b8b0f776f?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
    { title: 'Tax & Regulatory Compliance', text: 'Stay compliant with evolving tax laws and regulations, avoiding financial risks.', imgSrc: 'https://images.unsplash.com/vector-1738179384872-51a3d3435f64?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
    { title: 'Business Financial Analysis & Forecasting', text: 'Gain valuable insights with data-driven financial analysis and future forecasting.', imgSrc: 'https://images.unsplash.com/vector-1738932609116-27e932a40daa?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
    { title: 'Accounting & Bookkeeping Solutions', text: ' Maintain accurate records and streamlined financial operations with expert bookkeeping.', imgSrc: 'https://images.unsplash.com/vector-1739803318104-02a7807cd1a0?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
    { title: 'Cost Optimization Strategies', text: 'Reduce unnecessary expenses and improve financial efficiency to maximize profitability.', imgSrc: 'https://images.unsplash.com/vector-1739128047872-a82f4cced174?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
    { title: 'Investment & Fundraising Advisory', text: 'Get expert guidance on securing investments and optimizing funding opportunities.', imgSrc: 'https://images.unsplash.com/vector-1741055269272-f30d1e737eb9?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
    { title: 'Risk Management & Legal Compliance', text: ' Protect your business with proactive risk assessments and legal compliance strategies.', imgSrc: 'https://images.unsplash.com/vector-1740057539117-42cb2c6da083?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
  ];
