...
const SocialMedia = () => {
  ...
  const cardData = [
    ...
    { title: 'E-commerce Setup & Optimization', text: 'Understand market trends and competitor positioning to make informed decisions.', imgSrc: 'https://images.unsplash.com/vector-1739647326772-c15a9c69215d?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
    { title: 'SEO Strategy & Implementation', text: 'Establish a unique and memorable brand identity that stands out.', imgSrc: 'https://images.unsplash.com/vector-1740057539094-067a39d3d92a?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
    { title: 'Website Maintenance & Security', text: 'Identify and understand your target audience to better meet their needs.', imgSrc: 'https://images.unsplash.com/vector-1739128047857-cd4336451f32?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
    { title: 'Performance Analytics & Reporting', text: 'Revitalize your brand’s image to stay relevant and appealing.', imgSrc: 'https://images.unsplash.com/vector-1739128047872-a82f4cced174?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
    { title: 'Conversion Rate Optimization (CRO) ', text: 'Craft compelling stories that resonate with your audience.', imgSrc: 'https://images.unsplash.com/vector-1739647326715-454fb6be54be?q=80&w=2360&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
