...
const CustomParallax = () => {
  return (
    <div className="w-[100vw] py-[10vh] relative h-[full] overflow-x-hidden  flex items-center">
      ...
      <div className="relative  md:h-[70vh] flex md:space-x-10 text-black text-lg p-20 min-w-[200vw] animate-scroll">
        <p  style={{ WebkitTextStroke: "4px white" }} className='border-b border-gray-500/30 font-bold text-3xl md:text-[6vw] text-transparent'>We Ease, Structure, Implement, Deliver Impactful Results
