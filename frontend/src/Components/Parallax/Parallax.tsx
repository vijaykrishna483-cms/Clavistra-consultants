...
const CustomParallax = () => {
  return (
    <div className="w-[100vw] mt-[]] relative h-[100vh] overflow-x-hidden  flex items-center">
      <Parallax
        strength={500}
      ...
      <div className="relative h-[70vh] flex space-x-10 text-white text-lg p-20 min-w-[200vw] animate-scroll">
        <p  style={{ WebkitTextStroke: "2px white" }} className='border-b border-gray-500/30 font-bold text-5xl md:text-[6vw] text-transparent'>Design Thinking
Interior Design
Modern Structures
Architecture
</p>
